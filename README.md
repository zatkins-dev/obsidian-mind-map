...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/zatkins-dev/obsidian-mind-map/test.yml?branch=main) ![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/zatkins-dev/obsidian-mind-map?style=for-the-badge&sort=semver)
